...
class <?= $class_name ?> extends <?= $parent_class_name; ?><?= "\n" ?>
{
     ...
     * @IsGranted("ROLE_<?= strtoupper($entity_class_name) ?>_INDEX")
     */
<?php if (isset($repository_full_class_name)): ?>
...
<?php endif ?>
     ...
     * @Rest\View(StatusCode=200)
     * @IsGranted("ROLE_<?= strtoupper($entity_class_name) ?>_CREATE")
     */
     ...
     * @Rest\View(StatusCode=200)
     * @IsGranted("ROLE_<?= strtoupper($entity_class_name) ?>_SHOW")
     */
     ...
     * @Rest\View(StatusCode=200)
     * @IsGranted("ROLE_<?= strtoupper($entity_class_name) ?>_EDIT")
     */
     ...
     * @Rest\View(StatusCode=200)
     * @IsGranted("ROLE_<?= strtoupper($entity_class_name) ?>_CLONE")
     */
