...
//            ],
            ...
            $templatesPath . '-show.component.scss' => [
                ...
                'entity_fields' => $entityDoctrineDetails->getDisplayFields(),
                'route_name' => $routeName,
                'destination_path' =>$templatesPath . '/' . $templatesPath.'-show/'.$templatesPath.'-show.component.scss',
            ...
            $templatesPath . '-edit.component.scss' => [
                ...
                'entity_fields' => $entityDoctrineDetails->getDisplayFields(),
                'route_name' => $routeName,
                'destination_path' =>$templatesPath . '/' . $templatesPath.'-edit/'.$templatesPath.'-edit.component.scss',
            ...
            // clone
            $templatesPath . '-clone.component.html' => [
                'entity_class_name' => $entityClassDetails->getShortName(),
                'entity_var_singular' => $entityVarSingular,
                'entity_var_plural' => $entityVarPlural,
                'entity_identifier' => $entityDoctrineDetails->getIdentifier(),
                'entity_fields' => $entityDoctrineDetails->getDisplayFields(),
                'route_name' => $routeName,
                'destination_path' =>$templatesPath . '/' . $templatesPath.'-clone/'.$templatesPath.'-clone.component.html',
                'template_path' => 'crud/templates/clone.component.html.tpl.php',
            ],
            $templatesPath . '-clone.component.scss' => [
                'entity_class_name' => $entityClassDetails->getShortName(),
                'entity_var_singular' => $entityVarSingular,
                'entity_var_plural' => $entityVarPlural,
                'entity_identifier' => $entityDoctrineDetails->getIdentifier(),
                'entity_fields' => $entityDoctrineDetails->getDisplayFields(),
                'route_name' => $routeName,
                'destination_path' =>$templatesPath . '/' . $templatesPath.'-clone/'.$templatesPath.'-clone.component.scss',
                'template_path' => 'crud/templates/clone.component.scss.tpl.php',
            ],
            $templatesPath . '-clone.component.ts' => [
                'entity_class_name' => $entityClassDetails->getShortName(),
                'entity_var_singular' => $entityVarSingular,
                'entity_var_plural' => $entityVarPlural,
                'entity_identifier' => $entityDoctrineDetails->getIdentifier(),
                'entity_fields' => $entityDoctrineDetails->getDisplayFields(),
                'route_name' => $routeName,
                'destination_path' =>$templatesPath . '/' . $templatesPath.'-clone/'.$templatesPath.'-clone.component.ts',
                'template_path' => 'crud/templates/clone.component.ts.tpl.php',
            ],
            // list
            ...
            $templatesPath . '-list.component.scss' => [
                ...
                'entity_fields' => $entityDoctrineDetails->getDisplayFields(),
                'route_name' => $routeName,
                'destination_path' =>$templatesPath . '/' . $templatesPath.'-list/'.$templatesPath.'-list.component.scss',
            ...
            $templatesPath . '-new.component.scss' => [
                ...
                'entity_fields' => $entityDoctrineDetails->getDisplayFields(),
                'route_name' => $routeName,
                'destination_path' =>$templatesPath . '/' . $templatesPath.'-new/'.$templatesPath.'-new.component.scss',
